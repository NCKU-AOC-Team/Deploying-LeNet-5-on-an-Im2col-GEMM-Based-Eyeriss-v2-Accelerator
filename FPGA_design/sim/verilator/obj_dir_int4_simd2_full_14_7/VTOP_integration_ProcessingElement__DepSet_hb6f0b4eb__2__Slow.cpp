...
VL_ATTR_COLD void VTOP_integration_ProcessingElement___eval_final__TOP__TOP_integration__DOT__TOP_interface_inst__DOT__TOP_inst__DOT__ClusterGroup_array__DOT__ClusterGroup_1_1__PE_Cluster_inst__DOT__PE_INST_R__BRA__2__KET____DOT__PE_INST_C__BRA__1__KET____DOT__pe(VTOP_integration_ProcessingElement* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+                  VTOP_integration_ProcessingElement___eval_final__TOP__TOP_integration__DOT__TOP_interface_inst__DOT__TOP_inst__DOT__ClusterGroup_array__DOT__ClusterGroup_1_1__PE_Cluster_inst__DOT__PE_INST_R__BRA__2__KET____DOT__PE_INST_C__BRA__1__KET____DOT__pe\n"); );
    ...
    if (VL_UNLIKELY((((0U != vlSelfRef.__PVT__Processing_Element_core_inst__DOT__dbg_lane1_serial_cycles) 
        ...
        VL_WRITEF_NX("[pe_lane1] %NTOP_integration.TOP_interface_inst.TOP_inst.ClusterGroup_array.ClusterGroup_1_1.PE_Cluster_inst.PE_INST_R[2].PE_INST_C[1].pe.Processing_Element_core_inst serial_cycles=%0d bank_conflict_events=%0d parallel_events=%0d\n",0,
...
VL_ATTR_COLD void VTOP_integration_ProcessingElement___stl_sequent__TOP__TOP_integration__DOT__TOP_interface_inst__DOT__TOP_inst__DOT__ClusterGroup_array__DOT__ClusterGroup_1_1__PE_Cluster_inst__DOT__PE_INST_R__BRA__2__KET____DOT__PE_INST_C__BRA__1__KET____DOT__pe__0(VTOP_integration_ProcessingElement* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VTOP_integration__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                  VTOP_integration_ProcessingElement___stl_sequent__TOP__TOP_integration__DOT__TOP_interface_inst__DOT__TOP_inst__DOT__ClusterGroup_array__DOT__ClusterGroup_1_1__PE_Cluster_inst__DOT__PE_INST_R__BRA__2__KET____DOT__PE_INST_C__BRA__1__KET____DOT__pe__0\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_ATTR_COLD void VTOP_integration_ProcessingElement___eval_final__TOP__TOP_integration__DOT__TOP_interface_inst__DOT__TOP_inst__DOT__ClusterGroup_array__DOT__ClusterGroup_1_1__PE_Cluster_inst__DOT__PE_INST_R__BRA__2__KET____DOT__PE_INST_C__BRA__2__KET____DOT__pe(VTOP_integration_ProcessingElement* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VTOP_integration__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                  VTOP_integration_ProcessingElement___eval_final__TOP__TOP_integration__DOT__TOP_interface_inst__DOT__TOP_inst__DOT__ClusterGroup_array__DOT__ClusterGroup_1_1__PE_Cluster_inst__DOT__PE_INST_R__BRA__2__KET____DOT__PE_INST_C__BRA__2__KET____DOT__pe\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if (VL_UNLIKELY((((0U != vlSelfRef.__PVT__Processing_Element_core_inst__DOT__dbg_lane1_serial_cycles) 
                      | (0U != vlSelfRef.__PVT__Processing_Element_core_inst__DOT__dbg_lane1_bank_conflict_events)) 
                     | (0U != vlSelfRef.__PVT__Processing_Element_core_inst__DOT__dbg_lane1_parallel_events)))) {
        VL_WRITEF_NX("[pe_lane1] %NTOP_integration.TOP_interface_inst.TOP_inst.ClusterGroup_array.ClusterGroup_1_1.PE_Cluster_inst.PE_INST_R[2].PE_INST_C[2].pe.Processing_Element_core_inst serial_cycles=%0d bank_conflict_events=%0d parallel_events=%0d\n",0,
                     vlSymsp->name(),32,vlSelfRef.__PVT__Processing_Element_core_inst__DOT__dbg_lane1_serial_cycles,
                     32,vlSelfRef.__PVT__Processing_Element_core_inst__DOT__dbg_lane1_bank_conflict_events,
                     32,vlSelfRef.__PVT__Processing_Element_core_inst__DOT__dbg_lane1_parallel_events);
    }
...
VL_ATTR_COLD void VTOP_integration_ProcessingElement___stl_sequent__TOP__TOP_integration__DOT__TOP_interface_inst__DOT__TOP_inst__DOT__ClusterGroup_array__DOT__ClusterGroup_1_1__PE_Cluster_inst__DOT__PE_INST_R__BRA__2__KET____DOT__PE_INST_C__BRA__2__KET____DOT__pe__0(VTOP_integration_ProcessingElement* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VTOP_integration__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                  VTOP_integration_ProcessingElement___stl_sequent__TOP__TOP_integration__DOT__TOP_interface_inst__DOT__TOP_inst__DOT__ClusterGroup_array__DOT__ClusterGroup_1_1__PE_Cluster_inst__DOT__PE_INST_R__BRA__2__KET____DOT__PE_INST_C__BRA__2__KET____DOT__pe__0\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __PVT__FIFO_former_address_out_valid;
    __PVT__FIFO_former_address_out_valid = 0;
