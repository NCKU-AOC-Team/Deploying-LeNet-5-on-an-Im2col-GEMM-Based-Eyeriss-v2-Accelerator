...
module Router_Cluster (
	...
	output [0:2][0:2]       iact_GLB_address_in_ready,
	input  [0:2][0:2]       iact_GLB_address_in_valid,
	input  [0:2][0:2][6:0]  iact_GLB_address_in_bits,
	output [0:2][0:2]       iact_GLB_data_in_ready,
	input  [0:2][0:2]       iact_GLB_data_in_valid,
	...
	input  [0:2][0:2]       iact_PE_address_out_ready,
	output [0:2][0:2]       iact_PE_address_out_valid,
	output [0:2][0:2][6:0]  iact_PE_address_out_bits,
	input  [0:2][0:2]       iact_PE_data_out_ready,
	output [0:2][0:2]       iact_PE_data_out_valid,
