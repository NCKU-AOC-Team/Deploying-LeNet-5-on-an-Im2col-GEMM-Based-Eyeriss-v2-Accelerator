...
wire        [0:1][0:1][0:0]  ctrl_CG_PE_cluster_iact_data_in_sel;
wire        [0:1][0:1][1:0]  ctrl_CG_PE_cluster_iact_data_out_sel;
wire        [0:1][0:1][0:0]  ctrl_CG_PE_cluster_psum_data_in_sel;
wire        [0:1][0:1][1:0]  ctrl_CG_router_cluster_iact_data_in_sel;
wire        [0:1][0:1][1:0]  ctrl_CG_router_cluster_iact_data_out_sel;
wire        [0:1][0:1][0:0]  ctrl_CG_router_cluster_weight_data_in_sel;
wire        [0:1][0:1][0:0]  ctrl_CG_router_cluster_weight_data_out_sel;
wire        [0:1][0:1][0:0]  ctrl_CG_router_cluster_psum_data_in_sel;
wire        [0:1][0:1][0:0]  ctrl_CG_router_cluster_psum_data_out_sel;
wire        [0:1][0:1][0:0]  ctrl_CG_src_GLB_load_fin;
wire        [0:1][0:1][0:0]  ctrl_CG_cg_en;
wire        [0:1][0:1][0:0]  ctrl_CG_read_psum_en;
wire        [0:1][0:1][0:0]  ctrl_CG_psum_SRAM_Bank_0_read_out_en;
wire        [0:1][0:1][0:0]  ctrl_CG_psum_SRAM_Bank_1_read_out_en;
wire        [0:1][0:1][0:0]  ctrl_CG_psum_SRAM_Bank_2_read_out_en;
wire        [0:1][0:1][0:0]  ctrl_CG_GLB_psum_write_en;
wire        [0:1][0:1][0:0]  ctrl_CG_psum_spad_clear;
wire        [0:1][0:1][0:0]  ctrl_CG_iact_write_fin_clear;
wire        [0:1][0:1][0:0]  ctrl_CG_weight_write_fin_clear;
wire        [0:1][0:1][0:0]  CG_cal_fin;
wire        [0:1][0:1][0:0]  CG_PE_weight_load_en;
wire        [0:1][0:1][0:0]  CG_GLB_iact_load_en;
wire        [0:2][0:2][0:0]  ctrl_CG_0_0_PE_disable;
wire        [0:2][0:2][9:0]  CG_0_0_GLB_iact_read_addr;
wire        [0:2][9:0]       CG_0_0_GLB_psum_write_addr;
wire        [0:2][9:0]       CG_0_0_GLB_psum_read_addr;
wire        [0:2][0:2][0:0]  CG_0_0_GLB_iact_address_in_ready;
wire        [0:2][0:2][0:0]  CG_0_0_GLB_iact_address_in_valid;
wire        [0:2][0:2][6:0]  CG_0_0_GLB_iact_address_in;
wire        [0:2][0:2][0:0]  CG_0_0_GLB_iact_data_in_ready;
wire        [0:2][0:2][0:0]  CG_0_0_GLB_iact_data_in_valid;
wire        [0:2][0:2][11:0] CG_0_0_GLB_iact_data_in;
wire        [0:2]            CG_0_0_GLB_weight_address_in_ready;
wire        [0:2]            CG_0_0_GLB_weight_address_in_valid;
wire        [0:2][7:0]       CG_0_0_GLB_weight_address_in;
wire        [0:2]            CG_0_0_GLB_weight_data_in_ready;
wire        [0:2]            CG_0_0_GLB_weight_data_in_valid;
wire        [0:2][12:0]      CG_0_0_GLB_weight_data_in;
...
wire        [0:2][0:2][0:0]  ctrl_CG_0_1_PE_disable;
wire        [0:2][0:2][9:0]  CG_0_1_GLB_iact_read_addr;
wire        [0:2][9:0]       CG_0_1_GLB_psum_write_addr;
wire        [0:2][9:0]       CG_0_1_GLB_psum_read_addr;
wire        [0:2][0:2][0:0]  CG_0_1_GLB_iact_address_in_ready;
wire        [0:2][0:2][0:0]  CG_0_1_GLB_iact_address_in_valid;
wire        [0:2][0:2][6:0]  CG_0_1_GLB_iact_address_in;
wire        [0:2][0:2][0:0]  CG_0_1_GLB_iact_data_in_ready;
wire        [0:2][0:2][0:0]  CG_0_1_GLB_iact_data_in_valid;
wire        [0:2][0:2][11:0] CG_0_1_GLB_iact_data_in;
wire        [0:2]            CG_0_1_GLB_weight_address_in_ready;
wire        [0:2]            CG_0_1_GLB_weight_address_in_valid;
wire        [0:2][7:0]       CG_0_1_GLB_weight_address_in;
wire        [0:2]            CG_0_1_GLB_weight_data_in_ready;
wire        [0:2]            CG_0_1_GLB_weight_data_in_valid;
wire        [0:2][12:0]      CG_0_1_GLB_weight_data_in;
...
wire        [0:2][0:2][0:0]  ctrl_CG_1_0_PE_disable;
wire        [0:2][0:2][9:0]  CG_1_0_GLB_iact_read_addr;
wire        [0:2][9:0]       CG_1_0_GLB_psum_write_addr;
wire        [0:2][9:0]       CG_1_0_GLB_psum_read_addr;
wire        [0:2][0:2][0:0]  CG_1_0_GLB_iact_address_in_ready;
wire        [0:2][0:2][0:0]  CG_1_0_GLB_iact_address_in_valid;
wire        [0:2][0:2][6:0]  CG_1_0_GLB_iact_address_in;
wire        [0:2][0:2][0:0]  CG_1_0_GLB_iact_data_in_ready;
wire        [0:2][0:2][0:0]  CG_1_0_GLB_iact_data_in_valid;
wire        [0:2][0:2][11:0] CG_1_0_GLB_iact_data_in;
wire        [0:2]            CG_1_0_GLB_weight_address_in_ready;
wire        [0:2]            CG_1_0_GLB_weight_address_in_valid;
wire        [0:2][7:0]       CG_1_0_GLB_weight_address_in;
wire        [0:2]            CG_1_0_GLB_weight_data_in_ready;
wire        [0:2]            CG_1_0_GLB_weight_data_in_valid;
wire        [0:2][12:0]      CG_1_0_GLB_weight_data_in;
...
wire        [0:2][0:2][0:0]  ctrl_CG_1_1_PE_disable;
wire        [0:2][0:2][9:0]  CG_1_1_GLB_iact_read_addr;
wire        [0:2][9:0]       CG_1_1_GLB_psum_write_addr;
wire        [0:2][9:0]       CG_1_1_GLB_psum_read_addr;
wire        [0:2][0:2][0:0]  CG_1_1_GLB_iact_address_in_ready;
wire        [0:2][0:2][0:0]  CG_1_1_GLB_iact_address_in_valid;
wire        [0:2][0:2][6:0]  CG_1_1_GLB_iact_address_in;
wire        [0:2][0:2][0:0]  CG_1_1_GLB_iact_data_in_ready;
wire        [0:2][0:2][0:0]  CG_1_1_GLB_iact_data_in_valid;
wire        [0:2][0:2][11:0] CG_1_1_GLB_iact_data_in;
wire        [0:2]            CG_1_1_GLB_weight_address_in_ready;
wire        [0:2]            CG_1_1_GLB_weight_address_in_valid;
wire        [0:2][7:0]       CG_1_1_GLB_weight_address_in;
wire        [0:2]            CG_1_1_GLB_weight_data_in_ready;
wire        [0:2]            CG_1_1_GLB_weight_data_in_valid;
wire        [0:2][12:0]      CG_1_1_GLB_weight_data_in;
...
wire [0:2]           ctrl_CG_0_0_GLB_psum_out_en;
wire [0:2]           ctrl_CG_0_1_GLB_psum_out_en;
wire [0:2]           ctrl_CG_1_0_GLB_psum_out_en;
wire [0:2]           ctrl_CG_1_1_GLB_psum_out_en;
wire [0:2][0:2][0:0] ctrl_CG_0_0_GLB_iact_in_en;
wire [0:2][0:2][0:0] ctrl_CG_0_1_GLB_iact_in_en;
wire [0:2][0:2][0:0] ctrl_CG_1_0_GLB_iact_in_en;
wire [0:2][0:2][0:0] ctrl_CG_1_1_GLB_iact_in_en;
wire [0:2]           ctrl_CG_0_0_GLB_weight_in_en;
wire [0:2]           ctrl_CG_0_1_GLB_weight_in_en;
wire [0:2]           ctrl_CG_1_0_GLB_weight_in_en;
wire [0:2]           ctrl_CG_1_1_GLB_weight_in_en;
...
ClusterGroup_array ClusterGroup_array(
	...
	.CG_PE_cluster_psum_data_in_sel		(ctrl_CG_PE_cluster_psum_data_in_sel		),
	.CG_router_cluster_iact_data_in_sel		(ctrl_CG_router_cluster_iact_data_in_sel		),
	.CG_router_cluster_iact_data_out_sel		(ctrl_CG_router_cluster_iact_data_out_sel		),
	.CG_router_cluster_weight_data_in_sel		(ctrl_CG_router_cluster_weight_data_in_sel		),
	...
	.CG_0_0_GLB_iact_address_in_valid(CG_0_0_GLB_iact_address_in_valid),
	.CG_0_0_GLB_iact_address_in(CG_0_0_GLB_iact_address_in),
	.CG_0_0_GLB_iact_data_in_ready(CG_0_0_GLB_iact_data_in_ready),
	.CG_0_0_GLB_iact_data_in_valid(CG_0_0_GLB_iact_data_in_valid),
	.CG_0_0_GLB_iact_data_in(CG_0_0_GLB_iact_data_in),
	.CG_0_0_GLB_weight_address_in_ready(CG_0_0_GLB_weight_address_in_ready),
	.CG_0_0_GLB_weight_address_in_valid(CG_0_0_GLB_weight_address_in_valid),
	.CG_0_0_GLB_weight_address_in(CG_0_0_GLB_weight_address_in),
	.CG_0_0_GLB_weight_data_in_ready(CG_0_0_GLB_weight_data_in_ready),
	.CG_0_0_GLB_weight_data_in_valid(CG_0_0_GLB_weight_data_in_valid),
	.CG_0_0_GLB_weight_data_in(CG_0_0_GLB_weight_data_in),
	...
	.CG_0_1_GLB_iact_address_in_valid(CG_0_1_GLB_iact_address_in_valid),
	.CG_0_1_GLB_iact_address_in(CG_0_1_GLB_iact_address_in),
	.CG_0_1_GLB_iact_data_in_ready(CG_0_1_GLB_iact_data_in_ready),
	.CG_0_1_GLB_iact_data_in_valid(CG_0_1_GLB_iact_data_in_valid),
	.CG_0_1_GLB_iact_data_in(CG_0_1_GLB_iact_data_in),
	.CG_0_1_GLB_weight_address_in_ready(CG_0_1_GLB_weight_address_in_ready),
	.CG_0_1_GLB_weight_address_in_valid(CG_0_1_GLB_weight_address_in_valid),
	.CG_0_1_GLB_weight_address_in(CG_0_1_GLB_weight_address_in),
	.CG_0_1_GLB_weight_data_in_ready(CG_0_1_GLB_weight_data_in_ready),
	.CG_0_1_GLB_weight_data_in_valid(CG_0_1_GLB_weight_data_in_valid),
	.CG_0_1_GLB_weight_data_in(CG_0_1_GLB_weight_data_in),
	...
	.CG_1_0_GLB_iact_address_in_valid(CG_1_0_GLB_iact_address_in_valid),
	.CG_1_0_GLB_iact_address_in(CG_1_0_GLB_iact_address_in),
	.CG_1_0_GLB_iact_data_in_ready(CG_1_0_GLB_iact_data_in_ready),
	.CG_1_0_GLB_iact_data_in_valid(CG_1_0_GLB_iact_data_in_valid),
	.CG_1_0_GLB_iact_data_in(CG_1_0_GLB_iact_data_in),
	.CG_1_0_GLB_weight_address_in_ready(CG_1_0_GLB_weight_address_in_ready),
	.CG_1_0_GLB_weight_address_in_valid(CG_1_0_GLB_weight_address_in_valid),
	.CG_1_0_GLB_weight_address_in(CG_1_0_GLB_weight_address_in),
	.CG_1_0_GLB_weight_data_in_ready(CG_1_0_GLB_weight_data_in_ready),
	.CG_1_0_GLB_weight_data_in_valid(CG_1_0_GLB_weight_data_in_valid),
	.CG_1_0_GLB_weight_data_in(CG_1_0_GLB_weight_data_in),
	...
	.CG_1_1_GLB_iact_address_in_valid(CG_1_1_GLB_iact_address_in_valid),
	.CG_1_1_GLB_iact_address_in(CG_1_1_GLB_iact_address_in),
	.CG_1_1_GLB_iact_data_in_ready(CG_1_1_GLB_iact_data_in_ready),
	.CG_1_1_GLB_iact_data_in_valid(CG_1_1_GLB_iact_data_in_valid),
	.CG_1_1_GLB_iact_data_in(CG_1_1_GLB_iact_data_in),
	.CG_1_1_GLB_weight_address_in_ready(CG_1_1_GLB_weight_address_in_ready),
	.CG_1_1_GLB_weight_address_in_valid(CG_1_1_GLB_weight_address_in_valid),
	.CG_1_1_GLB_weight_address_in(CG_1_1_GLB_weight_address_in),
	.CG_1_1_GLB_weight_data_in_ready(CG_1_1_GLB_weight_data_in_ready),
	.CG_1_1_GLB_weight_data_in_valid(CG_1_1_GLB_weight_data_in_valid),
	.CG_1_1_GLB_weight_data_in(CG_1_1_GLB_weight_data_in),
