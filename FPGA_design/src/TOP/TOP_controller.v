...
(
	...
	output [0:2][0:2][0:0] CG_0_0_GLB_iact_in_en,
	output [0:2][0:2][0:0] CG_0_1_GLB_iact_in_en,
	output [0:2][0:2][0:0] CG_1_0_GLB_iact_in_en,
	output [0:2][0:2][0:0] CG_1_1_GLB_iact_in_en,
	...
	// ------------- CG_0_0 ------------- //
	output [0:1][0:1][0:0] CG_PE_cluster_iact_data_in_sel,
	output [0:1][0:1][1:0] CG_PE_cluster_iact_data_out_sel,
	output [0:1][0:1][0:0] CG_PE_cluster_psum_data_in_sel,
	
	output     [0:1][0:1][1:0] CG_router_cluster_iact_data_in_sel,
	output     [0:1][0:1][1:0] CG_router_cluster_iact_data_out_sel,
	output     [0:1][0:1][0:0] CG_router_cluster_weight_data_in_sel,
	output     [0:1][0:1][0:0] CG_router_cluster_weight_data_out_sel,
	output     [0:1][0:1][0:0] CG_router_cluster_psum_data_in_sel,
	output     [0:1][0:1][0:0] CG_router_cluster_psum_data_out_sel,
	output reg [0:1][0:1][0:0] CG_src_GLB_load_fin,
	output     [0:1][0:1][0:0] CG_cg_en,
	output     [0:1][0:1][0:0] CG_read_psum_en,
	output     [0:1][0:1][0:0] CG_psum_SRAM_Bank_0_read_out_en,
	output     [0:1][0:1][0:0] CG_psum_SRAM_Bank_1_read_out_en,
	output     [0:1][0:1][0:0] CG_psum_SRAM_Bank_2_read_out_en,
	output     [0:1][0:1][0:0] CG_GLB_psum_write_en,
	output     [0:1][0:1][0:0] CG_psum_spad_clear,
	output     [0:1][0:1][0:0] CG_iact_write_fin_clear,
	output     [0:1][0:1][0:0] CG_weight_write_fin_clear,
			
	input [0:1][0:1][0:0] CG_GLB_iact_load_en,
	input [0:1][0:1][0:0] CG_PE_weight_load_en,
	input [0:1][0:1][0:0] CG_cal_fin,
	
	output [0:2][0:2][0:0] CG_0_0_PE_disable,
	...
	output [0:2][0:2][0:0] CG_0_1_PE_disable,
	...
	output [0:2][0:2][0:0] CG_1_0_PE_disable,
	...
	output [0:2][0:2][0:0] CG_1_1_PE_disable,
